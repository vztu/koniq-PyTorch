...
for i in range(len(X1)):  # for each video
    mean_arr = np.mean(X1[i], axis=0)
    X_score1.append(mean_arr[0])
...
for i in range(len(X2)):  # for each video
    mean_arr = np.mean(X2[i], axis=0)
    X_score2.append(mean_arr[0])
...
for i in range(len(X3)):  # for each video
    mean_arr = np.mean(X3[i], axis=0)
    X_score3.append(mean_arr[0])
